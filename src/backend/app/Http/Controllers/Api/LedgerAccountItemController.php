...
class LedgerAccountItemController extends Controller
{
    ...
    {
        $query = LedgerAccountItem::with(['ledgerAccount', 'fundAccount', 'accountItem', 'project', 'user']);
    ...
    public function store(Request $request)
    {
        ...
        $entry = LedgerAccountItem::create([
        ...
        return response()->json([
            ...
            'data' => $entry->load(['ledgerAccount', 'fundAccount', 'accountItem', 'project']),
        ], 201);
    }
