  ...
  <div class="space-y-6">
    ...
    <ClientOnly>
      ...
      <KpiCard
        ...
        :subtitle="`Accounst Payable: ${currencyStore.formatCurrency(totalAccounstPayable)}`"
        type="rose"
      >
        <template #icon>
...
const totalAccounstPayable = computed(() => accounting.totalUnpaidBalance.value)
const totalAppSpent = computed(() => accounting.totalDebits.value - totalAccounstPayable.value)
const totalAppManagedFunds = computed(() => accounting.totalFundAccountsBalance.value + totalAppSpent.value)
