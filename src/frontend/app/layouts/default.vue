...
const pageTitle = computed(() => {
  ...
  if (route.path === '/ledgers') return 'Ledger Entries'
...
const currentPageGroup = computed(() => {
  if (route.path === '/' || route.path.startsWith('/project') || route.path.startsWith('/projects') || route.path === '/ledgers') return 'Main Ledger'
